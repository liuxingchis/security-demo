...
-- ----------------------------
INSERT INTO `sys_permission` VALUES (1, 'test', 'test');
INSERT INTO `sys_permission` VALUES (2, 'test2', 'test2');
...
CREATE TABLE `sys_request_path`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '请求路径' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_request_path
-- ----------------------------
INSERT INTO `sys_request_path` VALUES (1, '/test', 'test');
INSERT INTO `sys_request_path` VALUES (2, '/test2', 'test2');
...
INSERT INTO `sys_request_path_permission_relation` VALUES (2, 2, 2);
...
CREATE TABLE `sys_role_permission_relation`  (
  ...
  `permission_id` int(11) NULL DEFAULT NULL COMMENT '权限id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '角色-权限关联关系表' ROW_FORMAT = Dynamic;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, '用户1', 'user1', '123456', '2021-01-28 07:40:29', 1, 1, 1, 1, '2019-08-29 06:28:36', '2021-01-28 07:40:29', 1, 1);
...
CREATE TABLE `sys_user_role_relation`  (
  ...
  `role_id` int(11) NULL DEFAULT NULL COMMENT '角色id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户角色关联关系表' ROW_FORMAT = Dynamic;
